...
Hand [`docs/AGENT-SETUP.md`](docs/AGENT-SETUP.md) to your local AI
(Claude Code, Cursor, Gemini CLI). It picks the right flow and runs the
install with confirmation at every step.
